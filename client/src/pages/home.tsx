...
export function Home({ onStartAssessment, language }: HomeProps) {
  return (
    <div className="text-center mb-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&h=400')",
