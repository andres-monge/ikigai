export const translations = {
  en: {
    ...
    "welcome.subtitle": "Discover your reason for being with AI-powered career guidance",
    "welcome.description": "Join thousands who've discovered their perfect career path through our comprehensive assessment. Let Nami, our AI guide, help you uncover the intersection of what you love, what you're good at, what the world needs, and what you can be paid for.",
    ...
    "step1.description": "Let's start by understanding what truly energizes and excites you. Think about activities that make you lose track of time.",
    "step2.title": "Identify Your Skills",
    "step2.description": "Now let's explore your natural abilities and strengths. What do you excel at?",
    "step3.title": "Define Your Values",
    "step3.description": "Understanding your core values helps align your career with what matters most to you.",
    "step4.title": "Economic Considerations",
    "step4.description": "Let's discuss your financial goals and practical considerations for your career path.",
    
    // Results
    "results.title": "Your Ikigai Analysis",
    "results.subtitle": "Nami has analyzed your responses and discovered your unique purpose paths",
    ...
    "loading.analyzing": "Analyzing your responses to discover your unique ikigai paths",
  ...
  es: {
    ...
    "welcome.subtitle": "Descubre tu razón de ser con orientación profesional impulsada por IA",
    "welcome.description": "Únete a miles que han descubierto su trayectoria profesional perfecta a través de nuestra evaluación integral. Deja que Nami, nuestra guía de IA, te ayude a descubrir la intersección de lo que amas, en lo que eres bueno, lo que el mundo necesita y por lo que te pueden pagar.",
    ...
    "step1.description": "Comencemos entendiendo qué te energiza y emociona realmente. Piensa en actividades que te hacen perder la noción del tiempo.",
    "step2.title": "Identifica Tus Habilidades",
    "step2.description": "Ahora exploremos tus habilidades naturales y fortalezas. ¿En qué sobresales?",
    "step3.title": "Define Tus Valores",
    "step3.description": "Entender tus valores fundamentales ayuda a alinear tu carrera con lo que más te importa.",
    "step4.title": "Consideraciones Económicas",
    "step4.description": "Hablemos de tus objetivos financieros y consideraciones prácticas para tu trayectoria profesional.",
    
    // Results
    "results.title": "Tu Análisis Ikigai",
    "results.subtitle": "Nami ha analizado tus respuestas y descubierto tus caminos únicos de propósito",
    ...
    "loading.analyzing": "Analizando tus respuestas para descubrir tus caminos únicos de ikigai",
